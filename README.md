...
```javascript
operationSides = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-base-operation-sides@v0.0.3-umd/browser.js' )
```
...
[test-image]: https://github.com/stdlib-js/blas-base-operation-sides/actions/workflows/test.yml/badge.svg?branch=v0.0.3
[test-url]: https://github.com/stdlib-js/blas-base-operation-sides/actions/workflows/test.yml?query=branch:v0.0.3
