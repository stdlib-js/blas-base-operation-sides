...
```javascript
import operationSides from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-base-operation-sides@v0.0.1-deno/mod.js';
```

You can also import the following named exports from the package:

```javascript
import { enum } from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-base-operation-sides@v0.0.1-deno/mod.js';
```
